...
const styles = {
  ...
  input: { display: "", width: "100%", marginBottom: "10px", padding: "8px", borderRadius: "4px", border: "1px solid #ccc",fontfamily:"normal" },
  ...
  addBtn: { padding: "10px 20px", background: "DodgerBlue", color: "white", border: "none", cursor: "pointer" }
};
