...
const UserfundTransfer = ({ accounts, setAccounts }) => {
  ...
  return (
    ...
    <div style={{ paddingLeft: "7vh",width:"100vh" }}>
      <h1>Fund Transfer</h1>
      ...
      <div>
        ...
        <br />
        <select
          style={{ height: "7vh", width: "100vh", marginBottom: "10px" }}
          value={senderIndex}
        ...
        <br />
        <select
          style={{ height: "7vh", width: "100vh", marginBottom: "10px",font:"caption"  }}
          value={receiverIndex}
        ...
        <br />
        <input
          style={{ height: "5vh", marginBottom: "10px", width: "100vh",font:"caption",color:"gray"  }}
          type="text"
        ...
        <input
          style={{ height: "7vh", marginBottom: "10px", width: "100vh" ,font:"caption" }}
          type="number"
